...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-screen px-4 py-4 hidden md:flex md:flex-col bg-background w-[300px] flex-shrink-0",
          className,
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-full px-4 py-4 flex flex-col md:hidden items-center justify-between bg-background w-full",
        )}
        {...props}
      >
