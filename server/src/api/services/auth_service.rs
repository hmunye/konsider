...
use crate::api::controllers::Credentials;
use crate::api::repositories::fetch_credentials;
use crate::api::UserRole;
use crate::log::spawn_blocking_with_tracing;
use crate::{Error, Result};

#[tracing::instrument(name = "validating user credentials", skip(db_pool, payload))]
pub async fn validate_credentials(
    ...
    if let Some((stored_user_id, stored_password_hash, stored_user_role)) =
        fetch_credentials(db_pool, &payload.email).await?
    {
